...
<div class="tpsa-setting-wrapper">
    <div class="tpsa-general-settings-wrapper">
        <h2>
            <span><a href="<?php echo esc_url( $current_url ); ?>"><?php echo esc_html( $current_tab_label ); ?></a>
                <?php echo esc_html( ' / Two Factor Authentication Settings' ); ?>
            </span>
            <div class="tp-feature">
                <button class="tp-help-icon">?</button>
                <div class="tp-tooltip">
                    <p>This feature adds a critical second layer of login protection, requiring a time-sensitive
                        code
                        from the user’s personal device.</p>
                </div>
            </div>
        </h2>
