                ...
                'custom-login-url'     => array(
                    'fields' => array(
                        'enable'       => array(
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'To enable/disable custom login/logut url.', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'login-url'    => array(
                            'type'    => 'text',
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Protect your website by changing the login page URL.', 'admin-safety-guard' ),
                            'default' => get_tpsa_site_login_path(),
                        ),
                        'redirect-url' => array(
                            'type'    => 'text',
                            'label'   => __( 'Redirect URL', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Wp Admin redirect URL. <strong>Default</strong>: home_url()', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                        'logout-url'   => array(
                            'type'    => 'text',
                            'label'   => __( 'Redirect URL After Logout', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Redirect URL after Logout', 'admin-safety-guard' ),
                            'default' => get_tpsa_site_login_path(),
                        ),
