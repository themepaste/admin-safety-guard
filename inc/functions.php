                ...
                'limit-login-attempts' => array(
                    'fields' => array(
                        'enable'           => array(
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'To enable/disable limit login attempts.', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'max-attempts'     => array(
                            'type'    => 'number',
                            'label'   => __( 'Max Login Attempts', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Maximum number of login attempts within 1 day for temporarily blocked IP/user.', 'admin-safety-guard' ),
                            'default' => 3,
                        ),
                        'block-for'        => array(
                            'type'    => 'number',
                            'label'   => __( 'Lock for', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Add how many minutes will be locked.', 'admin-safety-guard' ),
                            'default' => 15,
                        ),
                        'max-lockout'      => array(
                            'type'    => 'number',
                            'label'   => __( 'Max Lockouts', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Maximum number of lockout within 1 days for temporarily blocked IP/user.', 'admin-safety-guard' ),
                            'default' => 3,
                        ),
                        'block-message'    => array(
                            'type'    => 'textarea',
                            'label'   => __( 'Blocked Message', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Blocked users can see this message when they are locked out.', 'admin-safety-guard' ),
                            'default' => __( 'You have been locked out due to too many login attempts.', 'admin-safety-guard' ),
                        ),
                        'block-ip-address' => array(
                            'type'    => 'single-repeater',
                            'label'   => __( 'Block with IP Address', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'IP addresses', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                    ),
                ),
