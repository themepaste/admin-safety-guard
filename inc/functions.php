 ...
 */
    function tpsa_settings_option() {
        return apply_filters(
            ...
            array(
                'analytics'           => array(
                    'label' => __( 'Safety Analytics', 'admin-safety-guard' ),
                    'icon'  => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-dashboard-icon lucide-layout-dashboard"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>',
                    'class' => '',
                ),
                'security-core'       => array(
                    'label' => __( 'Security Core', 'admin-safety-guard' ),
                ...
                'customize'           => array(
                    'label' => __( 'Customization & Access', 'admin-safety-guard' ),
            ...
            array(
                ...
                'admin-bar'            => array(
                    'fields' => array(
                        'enable'  => array(
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'To enable/disable admin bar', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'exclude' => array(
                            'type'    => 'multi-check',
                            'label'   => __( 'Exclude', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Exclude users', 'admin-safety-guard' ),
                            'default' => 'light',
                ...
                'custom-login-url'     => array(
                    'fields' => array(
                        'enable'       => array(
                            'type'    => 'switch',
                            'label'   => __( 'Enable Custom Login URL', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Moves sign-in to your own address. <strong>wp-login.php and wp-register.php then return 404 for everyone.</strong>', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'login-url'    => array(
                            'type'    => 'text',
                            'label'   => __( 'Login Address', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Your private sign-in slug, e.g. <code>my-secure-login</code>. Bookmark it — it is the only way in once saved.', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                        'redirect-url' => array(
                            'type'    => 'text',
                            'label'   => __( 'Send Strangers To', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Where logged-out visitors go if they try to open wp-admin. Leave empty for the home page.', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                        'logout-url'   => array(
                            'type'    => 'text',
                            'label'   => __( 'After Logout, Go To', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Where users land after signing out. Leave empty for the WordPress default.', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                ...
                'limit-login-attempts' => array(
                    'fields' => array(
                        'enable'           => array(
                            'type'    => 'switch',
                            'label'   => __( 'Enable Brute-Force Protection', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Locks out an IP address after too many failed sign-ins. Covers wp-login, XML-RPC, Application Passwords and theme login forms.', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'max-attempts'     => array(
                            'type'    => 'number',
                            'label'   => __( 'Failed Attempts Before Lockout', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Failed attempts allowed before an address is locked out. <strong>Recommended: 3-5.</strong>', 'admin-safety-guard' ),
                            'default' => 3,
                        ),
                        'block-for'        => array(
                            'type'    => 'number',
                            'label'   => __( 'Lockout Duration (minutes)', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'How long a locked-out address must wait before trying again. <strong>Recommended: 15-60.</strong>', 'admin-safety-guard' ),
                            'default' => 15,
                        ),
                        'max-lockout'      => array(
                            'type'    => 'number',
                            'label'   => __( 'Lockouts Before 24-Hour Block', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Lockouts within 24 hours before the address is blocked for a full day. <strong>Recommended: 3.</strong>', 'admin-safety-guard' ),
                            'default' => 3,
                        ),
                        'show-remaining'   => array(
                            'type'    => 'switch',
                            'label'   => __( 'Show Remaining Attempts', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Adds "2 attempts remaining" to the login error, so real users know where they stand.', 'admin-safety-guard' ),
                            'default' => 1,
                        ),
                        'notify-admin'     => array(
                            'type'    => 'switch',
                            'label'   => __( 'Email Me About Lockouts', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Email the admin on each lockout. Throttled to one message per address per hour.', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'block-message'    => array(
                            'type'    => 'textarea',
                            'label'   => __( 'Lockout Message', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Shown while an address is locked out. Use <code>{minutes}</code> for the time left.', 'admin-safety-guard' ),
                            'default' => __( 'You have been locked out due to too many failed sign-in attempts.', 'admin-safety-guard' ),
                        ),
                        'whitelist-ip'     => array(
                            'type'    => 'single-repeater',
                            'label'   => __( 'Trusted IP Addresses', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Never locked out. Add your own IP. Accepts <code>203.0.113.7</code>, <code>203.0.113.0/24</code> or <code>203.0.113.*</code> (IPv6 too).', 'admin-safety-guard' ),
                            'default' => array(),
                        ),
                        'block-ip-address' => array(
                            'type'    => 'single-repeater',
                            'label'   => __( 'Always Blocked IP Addresses', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Never allowed to reach the login page. Same address, CIDR and wildcard formats.', 'admin-safety-guard' ),
                            'default' => array(),
                        ),
                    ),
                ),
                ...
                'recaptcha'            => array(
                    'fields' => array(
                        'enable'     => array(
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'To enable/disable reCAPTCHA.', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'version'    => array(
                            'type'    => 'option',
                            'label'   => __( 'Version', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Select Google reCAPTCHA version', 'admin-safety-guard' ),
                            'default' => '',
                            'options' => array(
                                'v2' => 'v2',
                                'v3' => 'v3',
                        ...
                        'site-key'   => array(
                            'type'    => 'text',
                            'label'   => __( 'Site Key', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                        ...
                        'secret-key' => array(
                            'type'    => 'text',
                            'label'   => __( 'Secret Key', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                        ...
                        'theme'      => array(
                            'type'    => 'option',
                            'label'   => __( 'Theme', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Select your preferred theme', 'admin-safety-guard' ),
                            'default' => 'light',
                            'options' => array(
                                'light' => 'Light Theme',
                                'dark'  => 'Dark Theme',
                ...
                'two-factor-auth'      => array(
                    'fields' => array(
                        'otp-email'     => array(
                            'type'    => 'switch',
                            'label'   => __( 'Require Email Code At Sign-In', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'After the password, a one-time code is emailed and must be entered. <strong>A stolen password alone is then useless.</strong>', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'otp-roles'     => array(
                            'type'    => 'multi-check',
                            'label'   => __( 'Apply To Roles', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Leave all unticked to protect every account. Ticking only Administrator and Editor keeps sign-in simple for customers and subscribers.', 'admin-safety-guard' ),
                            'default' => array(),
                            'options' => get_tps_all_user_roles(),
                        ),
                        'otp-validity'  => array(
                            'type'    => 'number',
                            'label'   => __( 'Code Valid For (minutes)', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'How long a code works before it expires. <strong>Recommended: 5.</strong> Shorter is safer.', 'admin-safety-guard' ),
                            'default' => 5,
                        ),
                        'otp-length'    => array(
                            'type'    => 'number',
                            'label'   => __( 'Code Length', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Number of digits, between 4 and 8. <strong>Recommended: 6.</strong>', 'admin-safety-guard' ),
                            'default' => 6,
                        ),
                        'otp-max-tries' => array(
                            'type'    => 'number',
                            'label'   => __( 'Attempts Per Code', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Wrong guesses allowed before the code is destroyed and sign-in restarts. <strong>Recommended: 5.</strong>', 'admin-safety-guard' ),
                            'default' => 5,
                        ),
                        'email-subject' => array(
                            'type'    => 'text',
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Placeholders: <code>{otp}</code>, <code>{site_name}</code>. Leave empty for the default.', 'admin-safety-guard' ),
                            'default' => '{site_name} sign-in code: {otp}',
                        ),
                        'email-body'    => array(
                            'type'    => 'textarea',
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Placeholders: <code>{otp}</code>, <code>{site_name}</code>. Leave empty for the styled default email.', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                    ),
                ),
                'password-protection'  => array(
                    'fields' => array(
                        'enable'          => array(
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'To enable/disable password protection.', 'admin-safety-guard' ),
                            'default' => 0,
                        ),
                        'password'        => array(
                            'type'    => 'password',
                            'label'   => __( 'Set Password', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Password-protect the entire site to hide the content from public view and search engine bots / crawlers.', 'admin-safety-guard' ),
                            'default' => '',
                        ),
                        'password-expiry' => array(
                            'type'    => 'number',
                            'label'   => __( 'Password Access Duration', 'admin-safety-guard' ),
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'How long visitors can access the site after entering the correct password.', 'admin-safety-guard' ),
                            'default' => '15',
                        ),
                        'exclude'         => array(
                            'type'    => 'multi-check',
                            ...
                            'class'   => '',
                            'id'      => '',
                            'desc'    => __( 'Exclude user from this password protection', 'admin-safety-guard' ),
                            'default' => 'light',
                            'options' => array_merge(
                                array(
...
if ( ! function_exists( 'tp_svg_google' ) ) {
...
if ( ! function_exists( 'tp_svg_facebook' ) ) {
...
if ( ! function_exists( 'tp_svg_twitter' ) ) {
...
if ( ! function_exists( 'tp_svg_linkedin' ) ) {
